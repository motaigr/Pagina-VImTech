...
export function HeroSection() {
  ...
  return (
    <section
      id="hero-section"
      className="relative w-full bg-gradient-to-br from-[hsl(var(--primary))] to-[hsl(var(--secondary))] pt-8 pb-20 md:pt-16 md:pb-32 lg:pt-20 lg:pb-40 overflow-hidden"
    >
                ...
                >
                  <div className="relative w-full flex justify-center">
                    <img
                      ...
                      className="w-full h-auto object-contain max-h-[500px] md:max-h-[600px] drop-shadow-2xl rounded-xl border-2 border-white/20 shadow-xl"
