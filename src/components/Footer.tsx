export function Footer() {
  return (
    <footer className="bg-secondary text-[#E2E8F0] py-12 mt-auto">
      <div className="container mx-auto px-4">
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-sm text-gray-400 flex flex-col items-center gap-2">
          <p>
